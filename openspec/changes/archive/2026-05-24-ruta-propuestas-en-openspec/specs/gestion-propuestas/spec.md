...
La aplicación SHALL mostrar un panel “Propuestas” en `content`, ubicado debajo de “Cambios activos”, con visualización en grid de propuestas activas cargadas desde `openspec/propose/actives`.
...
- **THEN** la app crea un archivo markdown en `openspec/propose/actives` con header que incluya tipo y nombre
