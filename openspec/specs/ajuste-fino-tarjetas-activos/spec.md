# ajuste-fino-tarjetas-activos Specification

## Purpose
Establece los requisitos de ordenamiento y presentación visual de elementos dentro de las tarjetas de cambios activos en el dashboard.
