# schema-en-descripcion-proyecto Specification

## Purpose
Nueva capacidad para mostrar el campo schema del proyecto en el panel de descripción, leyendo desde openspec/config.yaml con manejo de fallback.
