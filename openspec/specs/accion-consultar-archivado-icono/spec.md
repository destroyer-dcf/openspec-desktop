# accion-consultar-archivado-icono Specification

## Purpose
Icon-only action button (eye icon) for querying archived changes in the UI. Provides compact interface for opening archived change query modals.
