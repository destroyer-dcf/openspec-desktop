# layout-paneles-columna-unica Specification

## Purpose
Define single-column layout constraints for pipeline panels, ensuring vertical consistency across Propuestas, Cambios activos, and Cambios archivados.
